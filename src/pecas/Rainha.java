...
{
	public Rainha(Tabuleiro tabuleiro,char cor) 
	{
		super(tabuleiro,cor);
		imagem = (cor == Constantes.branco) ? Constantes.imgRainhaBranco : Constantes.imgRainhaPreto;
	}
